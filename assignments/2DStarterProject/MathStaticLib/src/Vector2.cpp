...
Vector2 operator*(Vector2 & v2, Matrix2 & m2)
{
	...
	result.m_x = (v2.m_x * m2.m_column1->m_x) + 
				 (v2.m_y * m2.m_column2->m_x);

	result.m_y = (v2.m_x * m2.m_column1->m_y) + 
				 (v2.m_y * m2.m_column2->m_y);
...
{
	Vector2 result(0.0f, 0.0f);
	result.m_x = (m2.m_column1->m_x * v2.m_x) + 
				 (m2.m_column2->m_x * v2.m_y);

	result.m_y = (m2.m_column1->m_y * v2.m_x) + 
				 (m2.m_column2->m_y * v2.m_y);
